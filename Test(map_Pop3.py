...
def get_verification_code(email_address, password, max_retries, folder="Junk"):
    # Vòng lặp để thử lại
    for attempt in range(max_retries):
        try:
            ...
            if email_count > 0:
                ...
                print(f"Không có email trong thư mục {folder}.")
...
email_address = "wilsonqvickimichigan7176@hotmail.com"
password = "z0gyzVHMh"
max_retries = 10
result = get_verification_code(email_address, password, max_retries, folder="Junk")
